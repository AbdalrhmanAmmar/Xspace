    ...
    <div className="min-h-screen bg-slate-900">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">مرحباً بك في x-sace</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <UserPlus className="h-12 w-12 text-blue-400 mb-4 group-hover:scale-110 transition-transform" />
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-white mb-2">قائمة العملاء</h2>
            <p className="text-blue-200">عرض وإدارة جميع العملاء</p>
          </Link>
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-white mb-2">الاشتراكات</h2>
            <p className="text-blue-200">إدارة اشتراكات العملاء</p>
          </Link>
